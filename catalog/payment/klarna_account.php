<?php
// Text
$_['text_title']				= 'Conta Klarna - Pague desde %s por mês';
...
$_['text_information']			= 'Informação da Conta Klarna';
$_['text_additional']			= 'A conta Klarna necessita de informação adicional antes de processar a sua encomenda.';
...
$_['entry_pno']					= 'Número Pessoal';
$_['entry_dob']					= 'Data de Nascimento';
$_['entry_phone_no']			= 'Número de telefone';
$_['entry_street']				= 'Rua';
$_['entry_house_no']			= 'Número de porta';
$_['entry_house_ext']			= 'Número de porta adicional';
$_['entry_company']				= 'NIF';

// Help
$_['help_pno']					= 'Por favor introduza o seu número de segurança social.';
...
$_['error_address_match']		= 'O endereço de faturação e entrega têm de ser iguais se quiser usar pagamentos Klarna.';
